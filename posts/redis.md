...
내 블로그는 Vercel의 Serverless 환경에서 실행되고, Vercel 자체의 <b>SpeedInsights</b>를 통한 <b>Analytics</b>탭에서 어떤 함수와 api가 얼만큼 요청됐는지를
확인할 수 있기 때문에 운영자 입장에선 상세한 방문자의 통계 정보를 확인할 수 있다.
